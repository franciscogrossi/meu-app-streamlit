...
/* ... demais estilos que você já tenha ... */
...
if st.button("Analisar"):
    ...
    if df.empty:
        ...
        # Filtrar competições conforme a liga
        if liga_selecionada == "Premier League":
            df = df[df["Competicao"] == "Premier League"]
        elif liga_selecionada == "La Liga":
            # Ajuste se no FBref aparecer como "La Liga" ou "Primera División"
            df = df[df["Competicao"] == "La Liga"]
