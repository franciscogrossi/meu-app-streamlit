...
LIGAS = {
    ...
    "La Liga": {
        ...
        "Athletic Club": {
            "Iñaki Williams": "6a99e0b1",
            "Daniel Vivian": "ab7bf91d",
            "Nico Williams": "afdc14d7",
            "Álex Berenguer": "dc1c2fce",
            "Oihan Sancet": "bdb624a3",
            "Yuri Berchiche": "b6e50615",
            "Gorka Guruzeta": "6b5ea2f4",
            "Mikel Jauregizar": "2f5c78ca",
            "Aitor Paredes": "b906757a",
            "Iñigo Ruiz de Galarreta": "91f7631f",
            "Óscar de Marcos": "9f323c71",
            "Yeray Álvarez": "3ecc11d8",
            "Beñat Prados": "1f60244a",
            "Adama Boiro": "e7992f7b",
            "Andoni Gorosabel": "6f5f82c0",
            "Unai Gómez": "37db6cae",
            "Mikel Vesga": "b0fce72c",
            "Álvaro Djaló": "45c29ae7",
            "Iñigo Lekue": "59b7d823",
            "Unai Núñez": "be170419",
            "Ander Herrera": "436a9dd0",
...
def scrape_fbref(slug, nome_jogador, subpath, colunas_necessarias, nome_coluna_fbref, nome_coluna_final):
    ...
    # Tenta mostrar jogos como unused sub, se houver
    try:
...
st.markdown("<h1>Análise - Ligas</h1>", unsafe_allow_html=True)
...
with col1:
    time_selecionado = st.selectbox("Selecione o Time", list(LIGAS[liga_selecionada].keys()))
with col2:
    jogador = st.selectbox("Selecione o Jogador", list(LIGAS[liga_selecionada][time_selecionado].keys()))
with col3:
...
if st.button("Analisar"):
    ...
    slug = LIGAS[liga_selecionada][time_selecionado][jogador]
    ...
    with st.spinner("⚽ Buscando informações do jogador..."):
        if usar_offline:
            csv_name = f"dados_offline_{liga_selecionada}_{time_selecionado}_{jogador}_{estatistica}.csv"
    ...
    if df.empty:
        ...
        # Remove col. Equipe (não precisamos exibir)
